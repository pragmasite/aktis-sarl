    ...
    <section className="relative min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-primary via-primary to-blue-900">
        ...
        <div className="absolute inset-0 opacity-20">
          <div className="absolute top-1/4 right-0 w-96 h-96 bg-accent rounded-full filter blur-3xl"></div>
          <div className="absolute bottom-1/4 left-0 w-96 h-96 bg-blue-400 rounded-full filter blur-3xl opacity-20"></div>
        </div>
      </div>
